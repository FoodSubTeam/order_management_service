...
def init_topics():
    required_topics = [Topic.KITCHEN_ORDER.value, Topic.OFFER_SELECTED.value, Topic.SUBSCRIPTION_PAID.value, Topic.SUBSCRIPTION_CANCELED.value, Topic.CANCEL_SUBSCRIPTION.value, Topic.DELIVERY_ORDER.value]
